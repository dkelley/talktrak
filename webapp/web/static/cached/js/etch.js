...
(function() {
  ...
  views.Editor = Backbone.View.extend({
    ...
    changeButtons: function() {
      ...
      //   var $buttonEl = $('<a href="#" class="btn btn-small etch-editor-button etch-'+ button +'" title="'+ button.replace('-', ' ') +'"><span></span></a>');
      //   view.$el.append($buttonEl);
      // });

      view.$el.append('<a href="#" class="btn btn-small etch-bold" title="bold"><b>Bold</b></a>');
      view.$el.append('<a href="#" class="btn btn-small etch-italic" title="italic"><i>Italic</i></a>');
      view.$el.append('<a href="#" class="btn btn-small etch-underline" title="underline"><u>Underline</u></a>');
      view.$el.append('<a href="#" class="btn btn-small etch-unordered-list" title="list"><i class="icon-th-list"></i></a>');
      view.$el.append('<a href="#" class="btn btn-small etch-ordered-list" title="list">1. 2. 3.</a>');
      view.$el.append('<a href="#" class="btn btn-small etch-clear-formatting" title="list">Clear formatting</a>');
  ...
  _.extend(etch, {
    ...
    editableInit: function(e) {
      ...
      if (!$editor.size()) {
        ...
        $editable.parent().append($editor[0]);
